...
function program() {
  describe('Bad Fibonacci Implementation', function(){
    it("works", function() {
      var fib = Fibo();
    ...
    it("can do 250 passes <0.01s", function() {
      var fib = Fibo();
    ...
    it("can do MAX(1477) passes < 1000 μs", function() {
      var fib = Fibo();
    ...
    it("can do MAX(1477) passes < 500 μs", function() {
      var fib = Fibo();
      const limits = testLimit(1477,0.5);
      const stopwatch = new Timer();
      stopwatch.begin();
      let result = 0;
      let obj;
    ...
    it("can do MAX(1477) passes < 100 μs", function() {
      var fib = Fibo();
      const limits = testLimit(1477,0.1);
      const stopwatch = new Timer();
      stopwatch.begin();
      let result = 0;
      let obj;
